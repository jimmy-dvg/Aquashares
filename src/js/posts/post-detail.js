...
import { getLikesSummaryByPostIds } from '../reactions/reactions-service.js';
...
import { cleanupPostLikesRealtime, renderPostReactions } from './post-detail-reactions.js';
...
export async function initializePostDetailPage() {
  ...
  try {
    ...
    renderPostReactions(elements, postWithLikes, viewer, (message) => showError(elements, message));
