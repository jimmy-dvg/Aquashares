...
Добави изображенията в `docs/screenshots/` и остави имената по шаблона по-долу.

### Основни екрани

#### Начало (Feed)
![Начало](docs/screenshots/feed-home.png)

#### Създаване на публикация
![Създаване на публикация](docs/screenshots/create-post.png)

#### Детайл на публикация
![Детайл на публикация](docs/screenshots/post-detail.png)

#### Профил
![Профил](docs/screenshots/profile.png)

#### Чат
![Чат](docs/screenshots/chat.png)

#### Админ панел
![Админ панел](docs/screenshots/admin-panel.png)

### Препоръчан формат за скрийншоти

- Формат: PNG
- Ширина: 1440px (desktop) или 390px (mobile)
- Имена: `kebab-case` и описателни (напр. `feed-home.png`)
- Без чувствителни данни/токени/лични имейли
